...
const InitialHome = () => {
  ...
  const codeText = useMemo(() => {
    ...
    return `<span style="color:#6A9955">// Cloud engineer with diverse skills</span>
<span style="color:#569CD6">const</span> developer = {
  <span style="color:#9CDCFE">name</span>: <span style="color:#CE9178">'Eko Supriyanto'</span>,
