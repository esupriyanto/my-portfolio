...
const Seo = ({ title, description }: SeoInterface) => {
  return (
    <Head>
      <meta name="author" content="Eko Supriyanto" />
      <meta name="keywords" content="Cloud Engineer, Javascript, Python, DevOps" />
      <link rel="fluid-icon" href="/ts.png" title="Eko Supriyanto" />
